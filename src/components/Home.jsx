            ...
            <div className="card">
                <div className="product-card">
                    ...
                    <div className="product-card-rank">
                        ...
                        <p>上記のリンク以外で購入したユーザーは販売実績に含まれません。<br/>
                            SNS等で宣伝する時は必ず上記のリンクをご使用下さい。
                        </p>
                    </div>
                    <button onClick={()=>router.push(`/${userid}`)} className="product-card-change">サイトを見る</button>
                </div>                        
                ...
                <div key={index} className="product-card">
                    ...
                    <div className="product-card-items">
                        ...
                        <div className="product-card-item-balance">
                            <input id={`price-${item.id}`} type="text" defaultValue={parseInt(item.price_sell).toLocaleString('en-US').toString()}/>
                        </div>
                        <div className="product-card-item-unit">
                            円
                        </div>
                        <div  className="product-card-change">変更可</div>
                    </div>
                    <p style={{color:"red", marginTop:"-25px", textAlign:"right"}}>数値を変更するときは、カンマを入れずに<br/>
                    入力して「更新」ボタンを押してください。</p>
                    <div className="product-card-items">
                        <div className="product-card-item-name">
                            仕入れ価格
                        </div>
                        <div className="product-card-item-balance">
                            <input type="text" defaultValue={parseInt(item.price_origin).toLocaleString('en-US').toString()}/>
                        </div>
                        <div className="product-card-item-unit">
                            円
                        </div>
                    ...
                    <div className="product-card-rank">
                        <div className="product-card-blank"></div>
                        <p>仕入れ価格はあなたの販売実績に応じて変動します<br/>
                            現在のあなたのランク：<strong>ブロンズ</strong></p>
                    </div>
                    <div className="product-card-items">
                        <div className="product-card-item-name">
                            販売時の利益
                        ...
                        <div className="product-card-item-balance">
                            <input type="text" defaultValue={parseInt(item.price_sell - item.price_origin).toLocaleString('en-US').toString()}/>
                        </div>
                        <div className="product-card-item-unit">
                            円
                        </div>
                    ...
                    <button className="product-card-change" onClick={()=>{handleUpdate(item.id)}}>更新</button>
                </div>
            ))}
                <div className="product-card">
                    <div className="product-card-title">
                    ...
                    <button onClick={handleResetCoupon} className="product-card-change">リセット</button>
                </div>                  
                <div className="product-card">
                    <div className="product-card-title">
                        実績
                    ...
                    <button href="" className="product-card-change">振込先情報の確認/設定</button>
                    <div className="blur">システムメンテナンス中</div>
                </div>
            </div>
            <a href="/dashboard#" className="back-top">▲ 上に戻る</a>
        </div>
    )
}
