            ...
            <div className="card">
                <div className="product-card">
                    ...
                    <div className="product-card-items">
                        ...
                        <div className="product-card-item-balance full-width">
                            <input className='product-link' value={password} onChange={(e)=>setPassword(e.target.value)}/>
                        </div>
                    </div>
                    <button onClick={handleSubmit} className="product-card-change">パスワードの更新</button>
                </div>
